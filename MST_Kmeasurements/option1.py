...
parser.add_argument('--data_path_CAVE', default='/data/xuh/CAVE400700/', type=str,
                        help='path of data')
parser.add_argument('--data_path_KAIST', default='/data/xuh/KAIST400720/', type=str,
                    help='path of data')
parser.add_argument('--data_path_ICVL', default='/data/xuh/ICVL400700/', type=str,
                    help='path of data')
parser.add_argument('--mask_path', default='/workspace/huhq/MST/k_measurement/psf_4k.mat', type=str,
                    help='path of mask')

# Saving specifications
parser.add_argument('--outf', type=str, default='./exp/mst_s1/', help='saving_path')

# Model specifications
parser.add_argument('--method', type=str, default='mst_s1', help='method name')
