...
from .MST_Plus_Plus import MST_Plus_Plus_k
from .Lambda_Net import Lambda_Net
from .MST1 import MST1
from .MST_k import MST_k
...
def model_generator(method, pretrained_model_path=None):
    if method == 'mst_s':
        ...
        model = MST_k(k=4, dim=25, stage=2, num_blocks=[2, 2, 2]).cuda()
    elif method == 'gap_net':
        model = GAP_net().cuda()
        ...
        model = MST_Plus_Plus_k(k=2, in_channels=3, out_channels=25, n_feat=25, stage=3).cuda()
